      ...
      <div class="card mb-6">
        <div class="flex flex-col sm:flex-row items-start gap-5">
          ...
          <div class="flex flex-wrap gap-2">
            ...
            <button onclick="openCallPrepBriefing('${contact.id}')" class="btn-secondary btn-sm" title="AI call prep briefing">
            ...
            <button onclick="openContactResearch('${contact.id}')" class="btn-secondary btn-sm" title="AI personal research">
