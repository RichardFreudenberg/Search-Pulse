  ...
  if (projects.length === 0) {
    return `
      <div class="text-center py-16">
        <div class="w-16 h-16 rounded-2xl bg-brand-50 dark:bg-brand-900/20 flex items-center justify-center mx-auto mb-4">
...
function renderDDWorkstreamSection(wsInfo, w) {
  ...
  return `
    <div id="ws-section-${wsInfo.id}" class="card p-5">
      ...
      <!-- Red Flags -->
      ${w.redFlags?.length ? `
        <div class="mt-4 p-3 rounded-xl bg-red-50 dark:bg-red-900/10 border border-red-200 dark:border-red-800/30">
